...
for t,p,ppty,src in zip(T,P,Property, Source): model.addPoint(t,p,ppty,src,callback="delineateSpinodal")
model.plot(savefig=True,skip=['Widom'],style='ggplot',wait=True)
model.writetoFile('All.dat',callback="delineateSpinodal")
...
for t,p,ppty,src in zip(T,P,Property,Source): model2.addPoint(t,p,ppty,src,offset,callback="delineateSpinodal")
model2.writetoFile("All.dat",offsetCriticalPt=offset,isnew=False,callback="delineateSpinodal")
